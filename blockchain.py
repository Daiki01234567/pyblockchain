...
MINING_DIFFICULTY = 3
MINING_SENDER = 'THE BLOCKCHAIN' # ブロックチェーンネットワーク
MINING_REWARD = 1.0              # 報酬
MINING_TIMER_SEC = 20

BLOCKCHAIN_PORT_RANGE = (5000, 5003)
NEIGHBOURS_IP_RANGW_NUM = (0, 1)
...
class BlockChain(object):
    ...
    def __init__(self, blockchain_address=None, port=None):
        ...
        self.blckchain_address = blockchain_address
        self.port = port
        self.mining_semaphoro = threading.Semaphore(1)
    ...
    def set_neighbours(self):
        self.neighbours = utils.find_neighbours(
            ...
            NEIGHBOURS_IP_RANGW_NUM[0], NEIGHBOURS_IP_RANGW_NUM[1],
    ...
    def verity_transaction_signature(
    ...
    def valid_proof(self, transactions, previous_hash, nonce,
        ...
        return guess_hash[:difficuly] == '0'*difficuly
    ...
    def mining(self):
        ...
        self.add_transaction(
            ...
            recipient_blockchain_address=self.blckchain_address,
            value=MINING_REWARD
        )
    ...
    def start_mining(self):
        is_acquire = self.mining_semaphoro.acquire(blocking=False)
        if is_acquire:
            with contextlib.ExitStack() as stack:
                stack.callback(self.mining_semaphoro.release)
                self.mining()
    ...
    def resolve_conflicts(self):
        ...
        for node in self.neighbours:
            ...
            if response.status_code == 200:
                logger.info({'action': 'resolve_conflicts', 'status': requests.status_codes})
